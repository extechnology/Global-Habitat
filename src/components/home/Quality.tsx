...
function Quality() {
  ...
  return (
    <section className="relative bg-[var(--ink)] text-white py-32 md:py-40 overflow-hidden">
      ...
      <div className="relative container-luxe">
        <Reveal>
          <p className="eyebrow text-[var(--gold)]">Construction Quality</p>
        </Reveal>
        <Reveal delay={0.1}>
        ...
        <div className="mt-20 grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 rounded-sm overflow-hidden">
          {steps.map((s, i) => (
            <Reveal key={s.year} delay={i * 0.08} className="bg-[var(--ink)]">
              <div className="p-8 md:p-10 h-full border-t border-[var(--gold)]/60">
                <p className="text-display italic text-[var(--gold)] text-xl">
                  {s.year}
                </p>
