...
function Updates() {
  ...
  return (
    <section
      id="updates"
      className="relative bg-accent py-8 md:py-36"
    >
      <div className="container-luxe px-4 grid lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-5">
          ...
          <Reveal delay={0.2}>
            <p className="mt-3 text-muted-foreground text-xs md:text-sm leading-relaxed max-w-md">
        ...
        <Reveal direction="right" className="lg:col-span-7">
          <div className="bg-white rounded-md border border-border shadow-soft overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-border">
              ...
              <p className="text-xs hidden md:block uppercase tracking-[0.25em] text-muted-foreground">
            ...
            <div className="p-5 md:p-10">
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <p className="text-display text-5xl mt-3 text-ink">
