      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="fixed bottom-24 right-7 z-40 grid place-items-center h-12 w-12 rounded-full bg-ink text-white shadow-soft hover:bg-gold hover:text-ink transition-colors"
          >
