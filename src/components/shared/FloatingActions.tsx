  ...
  return (
    <>
      <motion.div
        ...
        className="fixed top-0 left-0 right-0 h-[2px] origin-left bg-[var(--gold)] z-[60]"
      />
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-40 grid place-items-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-[var(--shadow-elevate)] hover:scale-105 transition-transform"
      >
